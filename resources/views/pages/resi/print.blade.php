        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-6" style="border-style: none none none solid; border-left-width: 1px;">
                    <div class="row">
                        <div class="col-10">
                            ...
                            <p style="font-size: 12px;" class="text-uppercase text-black mt-n3"><strong>Ruang Guru Ruangguru Privat Jogja</strong></p>
                            ...
                            <textarea name="deskripsi" id="deskripsi" style="resize:none; font-size: 8px;"
                                class="border-0 bg-transparent mt-n3" disabled cols="30" rows="3">asdasd</textarea>
                            <p style="font-size: 8px;">Special Intruction / Intruksi Khusus :</p>
                            <textarea name="intruction" id="intruction" style="resize:none; font-size: 8px;"
                                class="border-0 bg-transparent mt-n3" disabled cols="30" rows="2">asdasd</textarea>
                ...
                <div class="col-6" style="border-style: none none none solid; border-left-width: 1px;">
                    ...
                    <textarea name="deskripsi" id="deskripsi" style="resize:none; font-size: 8px;"
                        class="border-0 bg-transparent mt-n3" disabled cols="50" rows="3">asdasd</textarea>
                    ...
                    <textarea name="intruction" id="intruction" style="resize:none; font-size: 8px;"
                        class="border-0 bg-transparent mt-n3" disabled cols="30" rows="3"></textarea>
